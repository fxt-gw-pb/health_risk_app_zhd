// ⚠️ ════════════════════════════════════════════════════════════════════
// ⚠️  FROZEN MEDICAL KERNEL — 医学计算内核，禁止修改
// ⚠️  受 golden 测试锁定：src/kernel/__tests__/cox.golden.test.js
// ⚠️  不得改动：Cox 系数 betas / 均值 means / 基线生存率 baselineSurvival /
// ⚠️           诊断阈值 DIAGNOSTIC_RULES / cIndex。AI 只解释，绝不参与计算。
// ⚠️  如需改动须先更新 golden 基线并经评审。统一入口见 src/kernel/index.js。
// ⚠️ ════════════════════════════════════════════════════════════════════
// ========================================================================
